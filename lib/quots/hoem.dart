...
import 'package:firebaseapp/quots/constabt.dart';
...
class HomeScreenssss extends StatefulWidget {
  const HomeScreenssss({Key? key}) : super(key: key);

  @override
  _HomeScreenssssState createState() => _HomeScreenssssState();
}

class _HomeScreenssssState extends State<HomeScreenssss> {
  List? imageList;
  int? imageNumber = 0;
