...
class Funnypic extends StatefulWidget {
  _FunnypicState createState() => _FunnypicState();
}
class _FunnypicState extends State<Funnypic> {
  ...
  void initState() {
    ...
    futureFiles = FirebaseApi.listAll('funny/');
  }
