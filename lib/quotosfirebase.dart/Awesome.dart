...
class Awersome extends StatefulWidget {
  _AwersomeState createState() => _AwersomeState();
}

class _AwersomeState extends State<Awersome> {
  ...
  void initState() {
    ...
    futureFiles = FirebaseApi.listAll('Awersome/');
  }
